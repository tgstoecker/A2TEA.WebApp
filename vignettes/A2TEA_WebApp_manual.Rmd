...
Note that trying to show log2FoldChanges for a tree without any expression data present will result in an error message: `missing value where TRUE/FALSE needed`.  
